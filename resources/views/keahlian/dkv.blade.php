  ...
  <section class="vid-section" id="video-aphp">
    ...
    <div class="vid-wrap">
      ...
      <div class="vid-stage" data-reveal="right">
        ...
        <div class="vid-player" role="button" tabindex="0" aria-label="Putar video pengenalan DKV" onclick="alert('Video pengenalan DKV akan diputar di sini.')">
  ...
  <section class="vt-section" id="lab-tour" aria-label="Studio Tour DKV SMK Negeri 2 Mojokerto">
    ...
    <div class="vt-inner">
      <div class="vt-media" data-reveal="left">
        <div class="vt-frame">
          <img src="{{ asset('images/aphp-lab.jpg') }}" alt="Studio DKV SMK Negeri 2 Mojokerto — Studio Tour" loading="lazy">
      ...
      <div class="vt-copy">
        ...
        <a href="#" id="labTourLink" class="vt-btn" data-reveal>Mulai Studio Tour <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>
  </section>
