...
.produk-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1.6rem;width:min(1200px,92%);margin:auto}
.produk-card{position:relative;background:#fff;border:1px solid rgba(13,58,102,.14);border-radius:22px;
  overflow:hidden;box-shadow:0 20px 45px rgba(13,58,102,.08);
  transition:transform .35s ease,box-shadow .35s ease,border-color .35s ease}
.produk-card:hover{transform:translateY(-9px);box-shadow:0 30px 62px rgba(13,58,102,.2);border-color:rgba(255,179,0,.45)}
.produk-photo{position:relative;aspect-ratio:4/3;overflow:hidden;isolation:isolate;
...
.produk-photo::after{content:"";position:absolute;top:-34px;right:-34px;width:120px;height:120px;
  border:2px solid rgba(255,213,74,.4);transform:rotate(45deg);z-index:0}
.produk-photo i{position:relative;z-index:1;font-size:3.3rem;color:#ffd54a;
  filter:drop-shadow(0 12px 24px rgba(4,26,48,.35));
  transition:transform .45s ease}
.produk-card:hover .produk-photo i{transform:scale(1.16) rotate(-6deg)}
.produk-photo-mark{position:absolute;left:14px;bottom:12px;z-index:2;font-size:.6rem;font-weight:900;
  letter-spacing:.16em;text-transform:uppercase;color:rgba(255,255,255,.92);
  background:rgba(8,39,68,.35);padding:.3rem .6rem;border-radius:999px;border:1px solid rgba(255,255,255,.25);
  backdrop-filter:blur(4px)}
.produk-overlay{position:absolute;inset:0;z-index:2;opacity:0;transition:opacity .4s ease;
  background:linear-gradient(180deg,rgba(8,39,68,0) 35%,rgba(8,39,68,.9) 100%);
  display:flex;flex-direction:column;justify-content:flex-end;padding:1.15rem 1.25rem}
.produk-card:hover .produk-overlay{opacity:1}
.produk-overlay span{font-size:.64rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase;color:#ffd54a;margin-bottom:.25rem}
.produk-overlay h3{font-family:var(--font-display);font-size:1.2rem;font-weight:800;color:#fff;margin:0}
.produk-info{padding:1.05rem 1.25rem 1.2rem;display:flex;align-items:center;justify-content:space-between;gap:.75rem}
.produk-info h3{font-family:var(--font-display);font-size:.98rem;font-weight:800;color:#0d3a66;margin:0}
.produk-info .produk-badge{font-size:.6rem;font-weight:900;letter-spacing:.06em;text-transform:uppercase;color:#b26a00;
...
<div class="aphp-page">
  ...
  <section class="profil-section">
    ...
    <div class="aphp-wide profil-grid">
      <div data-reveal>
        ...
        <p class="profil-copy">Program Keahlian <strong>Agribisnis Pengolahan Hasil Pertanian (APHP)</strong> membekali peserta didik dengan pengetahuan dan keterampilan mengolah bahan hasil pertanian menjadi produk olahan yang berkualitas, aman dikonsumsi, dan bernilai jual tinggi. Kurikulum berorientasi pada praktik nyata: mulai dari penanganan bahan baku, teknik pengolahan, pengemasan, hingga pemasaran produk.</p>
        <p class="profil-copy">Lulusan APHP siap bekerja di industri pangan (food processing), menjadi wirausaha produk olahan, atau melanjutkan studi di bidang teknologi pangan dan agribisnis. Kompetensi lulusan diselaraskan dengan kebutuhan dunia usaha dan dunia industri (DUDI) serta sertifikasi profesi.</p>
      </div>
  ...
  <section class="kompetensi-section">
    ...
    <div class="kompetensi-grid">
      <article class="kompetensi-card" data-num="01" data-reveal>
        ...
        <h3>Penanganan Bahan Baku</h3>
        <p>Menerima, memilah, dan menilai mutu hasil pertanian (sayur, buah, biji-bijian, dan ternak) sesuai standar pengolahan pangan.</p>
      </article>
      <article class="kompetensi-card" data-num="02" data-reveal style="--d:1">
        ...
        <h3>Teknik Pengolahan Pangan</h3>
        <p>Menguasai metode pengolahan: pengeringan, penggorengan, fermentasi, pengemasan vakum, dan sterilisasi produk pangan.</p>
      </article>
      <article class="kompetensi-card" data-num="03" data-reveal style="--d:2">
        <div class="kompetensi-icon"><i class="fas fa-flask-vial"></i></div>
        <h3>Keamanan &amp; Mutu Produk</h3>
        <p>Menerapkan higiene sanitasi, pengujian mutu, dan standar keamanan pangan (GMP/SSOP) pada setiap tahap produksi.</p>
      </article>
      <article class="kompetensi-card" data-num="04" data-reveal>
        <div class="kompetensi-icon"><i class="fas fa-box-open"></i></div>
        <h3>Pengemasan &amp; Penyimpanan</h3>
        <p>Merancang kemasan menarik dan fungsional serta mengelola penyimpanan produk agar awet dan tetap bermutu tinggi.</p>
      </article>
      <article class="kompetensi-card" data-num="05" data-reveal style="--d:1">
        <div class="kompetensi-icon"><i class="fas fa-chart-line"></i></div>
        <h3>Pemasaran Produk</h3>
        <p>Mempelajari strategi pemasaran, branding produk olahan, penetapan harga, dan penjualan daring maupun luring.</p>
      </article>
      <article class="kompetensi-card" data-num="06" data-reveal style="--d:2">
        <div class="kompetensi-icon"><i class="fas fa-lightbulb"></i></div>
        <h3>Kewirausahaan</h3>
        <p>Mengembangkan jiwa wirausaha: ide produk, perhitungan usaha, manajemen produksi, hingga membangun usaha mandiri.</p>
      </article>
    </div>
  </section>
  ...
  <section class="produk-section">
    ...
    <div class="produk-grid">
      <article class="produk-card" data-reveal>
        <div class="produk-photo" style="--p1:#0d3a66;--p2:#2f6fa8">
          <i class="fas fa-bowl-food"></i>
          <span class="produk-photo-mark">Keripik Singkong</span>
          <div class="produk-overlay">
            <span>Olahan Singkong</span>
            <h3>Keripik Singkong</h3>
          </div>
        </div>
        <div class="produk-info">
          <h3>Keripik Singkong</h3>
          <span class="produk-badge">Andalan</span>
        </div>
      </article>
      <article class="produk-card" data-reveal style="--d:1">
        <div class="produk-photo" style="--p1:#143f70;--p2:#3d7fb8">
          <i class="fas fa-wine-bottle"></i>
          <span class="produk-photo-mark">Sirup Buah</span>
          <div class="produk-overlay">
            <span>Minuman</span>
            <h3>Sirup Buah</h3>
          </div>
      ...
      <article class="produk-card" data-reveal style="--d:2">
        <div class="produk-photo" style="--p1:#0e3d6b;--p2:#2f6fa8">
          <i class="fas fa-candy-cane"></i>
          <span class="produk-photo-mark">Dodol &amp; Manisan</span>
          <div class="produk-overlay">
            <span>Manisan</span>
            <h3>Dodol &amp; Manisan</h3>
          </div>
        ...
        <div class="produk-info">
          <h3>Dodol &amp; Manisan</h3>
          <span class="produk-badge">Tradisional</span>
        </div>
      </article>
      <article class="produk-card" data-reveal>
        <div class="produk-photo" style="--p1:#153f72;--p2:#4283bd">
          <i class="fas fa-drumstick-bite"></i>
          <span class="produk-photo-mark">Abon Sapi &amp; Ayam</span>
          <div class="produk-overlay">
            <span>Olahan Daging</span>
            <h3>Abon Sapi &amp; Ayam</h3>
          </div>
        </div>
        <div class="produk-info">
          <h3>Abon Sapi &amp; Ayam</h3>
      ...
      <article class="produk-card" data-reveal style="--d:1">
        <div class="produk-photo" style="--p1:#0d3a66;--p2:#356f9e">
          <i class="fas fa-pepper-hot"></i>
          <span class="produk-photo-mark">Sambal Kemasan</span>
          <div class="produk-overlay">
            <span>Sambal &amp; Bumbu</span>
            <h3>Sambal Kemasan</h3>
          </div>
        </div>
        <div class="produk-info">
          <h3>Sambal Kemasan</h3>
          <span class="produk-badge">Praktis</span>
        </div>
      </article>
      <article class="produk-card" data-reveal style="--d:2">
        <div class="produk-photo" style="--p1:#11395f;--p2:#2f6fa8">
          <i class="fas fa-leaf"></i>
          <span class="produk-photo-mark">Minuman Herbal</span>
          <div class="produk-overlay">
            <span>Herbal</span>
            <h3>Minuman Herbal</h3>
          </div>
        </div>
        <div class="produk-info">
          <h3>Minuman Herbal</h3>
          <span class="produk-badge">Sehat</span>
        </div>
      </article>
    </div>
  </section>
