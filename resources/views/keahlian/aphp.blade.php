...
<style>
/* =========================================================
   APHP — FROM FARM TO FUTURE
   Mini website premium khusus APHP di dalam website sekolah.
   Konsep: FARM → PROCESS → PRODUCT → INDUSTRY → FUTURE
   Palet: navy #0d3a66, blue #0B5FA5, bright blue #28A9E1,
          gold #FFD54A, orange #FF8A00, green APHP #6FAF45, white #F8FBFF
   ========================================================= */
...
/* ===== HERO — DISALIN 1:1 DARI HALAMAN SEJARAH, judul tetap APHP ===== */
...
/* Override khusus: watermark judul besar di background hero -> APHP (bukan SEJARAH) */
.aphp-page .history-hero::after{
  content:"APHP"!important;
}
...
/* ===== SECTION 2 — TENTANG APHP / FROM FARM TO PRODUCT ===== */
...
.tentang-section::after{content:"APHP";position:absolute;right:-5%;bottom:-10%;font-family:var(--font-display);font-size:clamp(10rem,25vw,22rem);font-weight:900;line-height:.8;letter-spacing:-.04em;color:rgba(7,27,51,.025);pointer-events:none}
...
.aphp-cta::after{content:"#APHP";position:absolute;left:50%;bottom:-30px;transform:translateX(-50%);font-family:var(--font-display);font-size:clamp(5rem,16vw,14rem);font-weight:900;line-height:1;color:rgba(255,255,255,.035);pointer-events:none;white-space:nowrap;user-select:none}
...
/* ===== APHP INDUSTRY PARTNERS — CLEAN LOGO MARQUEE ===== */
.industry-collab{
  position:relative;
  overflow:hidden;
  isolation:isolate;
...
/* =========================================================
   ...
   Hanya konten, gambar, label, dan anchor yang disesuaikan untuk APHP.
   ========================================================= */
...
@section('content')
<div class="aphp-page">
  <!-- ===== HERO — sama persis dengan hero halaman Sejarah, judul APHP ===== -->
  <section class="history-hero">
    ...
    <div class="history-hero-inner">
      <div>
        <div class="history-kicker"><i class="fas fa-seedling"></i> PROGRAM KEAHLIAN APHP</div>
  ...
  <section class="vid-section" id="video-aphp">
    <div class="orn" aria-hidden="true">
      ...
      <span class="o-gold"></span><i class="fas fa-wheat-awn o-wheat"></i>
      <i class="fas fa-flask o-flask"></i>
    </div>
    <div class="vid-wrap">
      <div class="vid-copy" data-reveal="left">
        ...
        <h2><span class="sejarah-white">MENGENAL LEBIH DEKAT</span><span class="t-gold"> APHP</span></h2>
        <p class="vc-desc">Kenali Program Keahlian Agribisnis Pengolahan Hasil Pertanian, mulai dari pembelajaran, kegiatan praktik, fasilitas, hingga berbagai pengalaman yang akan kamu dapatkan selama belajar di APHP.</p>
        <div class="vid-cards">
          <div class="vid-card">
            <span class="vc-ic green"><i class="fas fa-wheat-awn"></i></span>
            <b>Bahan Pertanian</b>
            <span>Mengenal potensi hasil pertanian</span>
          </div>
          <div class="vid-card">
            <span class="vc-ic"><i class="fas fa-flask"></i></span>
            <b>Teknologi Pengolahan</b>
            <span>Belajar proses pengolahan pangan</span>
          </div>
          <div class="vid-card">
            <span class="vc-ic gold"><i class="fas fa-box-open"></i></span>
            <b>Produk Bernilai</b>
            <span>Menghasilkan produk siap dikembangkan</span>
          </div>
        </div>
      </div>
      <div class="vid-stage" data-reveal="right">
        ...
        <div class="vid-player" role="button" tabindex="0" aria-label="Putar video pengenalan APHP" onclick="alert('Video pengenalan APHP akan diputar di sini.')">
          ...
          <span class="vid-brand"><b>APHP</b><span>Program Keahlian</span></span>
  ...
  <section class="tentang-section section-pad" id="tentang-aphp">
    ...
    <div class="aphp-wide tentang-grid">
      <div class="tentang-copy" data-reveal="left">
        ...
        <div class="eyebrow gold">Apa Itu APHP?</div>
        <h2 class="big-heading">DARI BAHAN BAKU<span> JADI PRODUK</span> BERNILAI</h2>

        <p class="tc-lead">Program Keahlian <strong>Agribisnis Pengolahan Hasil Pertanian (APHP)</strong> membekali peserta didik dengan keterampilan mengolah hasil pertanian menjadi produk berkualitas dan bernilai jual.</p>
        <p class="tc-sub">Pembelajaran mencakup pengolahan bahan nabati, hewani, herbal, dan perkebunan, pengujian mutu, pengemasan, serta pemasaran produk. Melalui praktik dan unit produksi, siswa belajar menghasilkan produk sekaligus mengembangkan jiwa kewirausahaan.</p>

        <div class="tentang-mini">
          <div class="tentang-mini-card">
            <span class="tm-ic"><i class="fas fa-wheat-awn"></i></span>
            <span>Agribisnis — Mengenal bahan &amp; hasil pertanian</span>
          </div>
          <div class="tentang-mini-card">
            <span class="tm-ic green"><i class="fas fa-flask"></i></span>
            <span>Teknologi — Mempelajari proses pengolahan</span>
          </div>
          <div class="tentang-mini-card">
            <span class="tm-ic gold"><i class="fas fa-bread-slice"></i></span>
            <span>Produk Pangan — Menghasilkan produk nyata</span>
          </div>
          <div class="tentang-mini-card">
            <span class="tm-ic"><i class="fas fa-chart-line"></i></span>
            <span>Kewirausahaan — Mengembangkan peluang usaha</span>
          </div>
        </div>
      </div>
      ...
      <div class="tentang-visual" data-reveal="right">
        <div class="tv-panel">
          <div class="tv-top">
            <div class="tv-top-label"><i class="fas fa-layer-group"></i> Alur APHP</div>
            <div class="tv-top-code">02 / APHP</div>
          </div>
          ...
          <div class="tv-center">
            <div class="tv-core">
              ...
              <strong>APHP</strong>
              <small>Farm to Future</small>
            </div>
          </div>

          <div class="tv-flow">
            <div class="tv-step">
              <span class="ts-ic"><i class="fas fa-wheat-awn"></i></span>
              <span class="ts-copy"><strong>Bahan Pertanian</strong><small>Mengenal potensi bahan</small></span>
              <i class="fas fa-arrow-right tv-arrow"></i>
            </div>
            <div class="tv-step">
              <span class="ts-ic green"><i class="fas fa-flask"></i></span>
              <span class="ts-copy"><strong>Pengolahan</strong><small>Proses menjadi produk</small></span>
              <i class="fas fa-arrow-right tv-arrow"></i>
            </div>
            <div class="tv-step">
              <span class="ts-ic blue"><i class="fas fa-microscope"></i></span>
              <span class="ts-copy"><strong>Uji Mutu</strong><small>Kualitas &amp; keamanan</small></span>
              <i class="fas fa-arrow-right tv-arrow"></i>
            </div>
            <div class="tv-step">
              <span class="ts-ic gold"><i class="fas fa-box-open"></i></span>
              <span class="ts-copy"><strong>Produk Bernilai</strong><small>Siap dikembangkan</small></span>
              <i class="fas fa-arrow-right tv-arrow"></i>
            </div>
          </div>

          <div class="tv-bottom">
            <span>AGRIBISNIS • TEKNOLOGI • PRODUK</span>
    ...
    <section class="industry-collab section-pad" id="industri-aphp">
      ...
      <div class="ic-head" data-reveal>
        <div class="eyebrow">Kerja Sama &amp; Dunia Industri</div>
        <h2 class="big-heading">BERKOLABORASI DENGAN <span>DUNIA INDUSTRI</span></h2>
      </div>
      <div class="ic-marquee-wrap" data-reveal aria-label="Mitra industri APHP">
        <div class="ic-marquee">
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/spat.png') }}" alt="Logo Sentra Pengembangan Agribisnis Terpadu" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','SPAT');"></span><span class="ic-name">Sentra Pengembangan Agribisnis Terpadu</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/kajeye-food.png') }}" alt="Logo CV Kajeye Food" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','KJF');"></span><span class="ic-name">CV Kajeye Food</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/bhumi-suryatama.png') }}" alt="Logo PT Bhumi Suryatama" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','BHM');"></span><span class="ic-name">PT Bhumi Suryatama</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/brawijaya-dairy.png') }}" alt="Logo CV Brawijaya Dairy Industry" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','BDI');"></span><span class="ic-name">CV Brawijaya Dairy Industry</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/sido-jodo.png') }}" alt="Logo PT Sido Jodo" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','SJD');"></span><span class="ic-name">PT Sido Jodo</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/olivia-bakery.png') }}" alt="Logo Olivia Bakery" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','OLI');"></span><span class="ic-name">Olivia Bakery</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/sydney-bakery.png') }}" alt="Logo Sydney Bakery" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','SYD');"></span><span class="ic-name">Sydney Bakery</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/munchies-bakery.png') }}" alt="Logo Munchies Bakery" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','MCH');"></span><span class="ic-name">Munchies Bakery</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/manna-bakery.png') }}" alt="Logo Manna Bakery" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','MNA');"></span><span class="ic-name">Manna Bakery</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/ada-rasa.png') }}" alt="Logo Ada Rasa Bakery" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','ADR');"></span><span class="ic-name">Ada Rasa Bakery</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/carrefour.png') }}" alt="Logo Carrefour Mojokerto" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','CRF');"></span><span class="ic-name">Carrefour Mojokerto</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/gunung-welirang.png') }}" alt="Logo Gunung Welirang" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','GWA');"></span><span class="ic-name">Gunung Welirang</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/ganessa.png') }}" alt="Logo Ganessa" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','GNS');"></span><span class="ic-name">Ganessa</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/bagus-agriseta.png') }}" alt="Logo Bagus Agriseta Mandiri" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','BAM');"></span><span class="ic-name">Bagus Agriseta Mandiri</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/spat.png') }}" alt="Logo Sentra Pengembangan Agribisnis Terpadu" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','SPAT');"></span><span class="ic-name">Sentra Pengembangan Agribisnis Terpadu</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/kajeye-food.png') }}" alt="Logo CV Kajeye Food" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','KJF');"></span><span class="ic-name">CV Kajeye Food</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/bhumi-suryatama.png') }}" alt="Logo PT Bhumi Suryatama" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','BHM');"></span><span class="ic-name">PT Bhumi Suryatama</span></div>
          <div class="ic-logo"><span class="ic-mark"><img src="{{ asset('images/mitra-aphp/brawijaya-dairy.png') }}" alt="Logo CV Brawijaya Dairy Industry" loading="lazy" onerror="this.style.display='none'; this.parentElement.classList.add('ic-fallback'); this.parentElement.setAttribute('data-fallback','BDI');"></span><span class="ic-name">CV Brawijaya Dairy Industry</span></div>
...
<!-- ===== SECTION 4 — PEMBELAJARAN ===== -->
  <section class="belajar-section section-pad" id="pembelajaran">
    ...
    <div class="belajar-grid">
      <div class="belajar-card" data-num="01" data-reveal>
        <div class="bc-ic"><i class="fas fa-flask"></i></div>
        <h4>Teknologi Pengolahan</h4>
        <p>Mempelajari teknik pengolahan bahan nabati, hewani, dan herbal menjadi produk berkualitas.</p>
        <span class="bc-arrow">Pelajari <i class="fas fa-arrow-right"></i></span>
      </div>
      <div class="belajar-card" data-num="02" data-reveal style="--d:1">
        <div class="bc-ic green"><i class="fas fa-wheat-awn"></i></div>
        <h4>Bahan Hasil Pertanian</h4>
        <p>Mengenal karakteristik, penanganan, dan pengolahan berbagai bahan hasil pertanian.</p>
        <span class="bc-arrow">Pelajari <i class="fas fa-arrow-right"></i></span>
      </div>
      <div class="belajar-card" data-num="03" data-reveal style="--d:2">
        <div class="bc-ic blue"><i class="fas fa-microscope"></i></div>
        <h4>Analisis &amp; Mutu</h4>
        <p>Mempelajari pengujian mutu produk: kadar air, keasaman, uji organoleptik, dan keamanan pangan.</p>
        <span class="bc-arrow">Pelajari <i class="fas fa-arrow-right"></i></span>
      </div>
      <div class="belajar-card" data-num="04" data-reveal style="--d:3">
        <div class="bc-ic gold"><i class="fas fa-clipboard-check"></i></div>
        <h4>Higiene &amp; Sanitasi</h4>
        <p>Menerapkan prinsip kebersihan dan keamanan pangan dalam setiap proses produksi.</p>
        <span class="bc-arrow">Pelajari <i class="fas fa-arrow-right"></i></span>
      </div>
      <div class="belajar-card" data-num="05" data-reveal style="--d:4">
        <div class="bc-ic"><i class="fas fa-box-open"></i></div>
        <h4>Pengemasan</h4>
        <p>Merancang kemasan yang menarik, aman, dan sesuai standar industri pangan.</p>
        <span class="bc-arrow">Pelajari <i class="fas fa-arrow-right"></i></span>
      </div>
      <div class="belajar-card" data-num="06" data-reveal style="--d:5">
        <div class="bc-ic gold"><i class="fas fa-chart-line"></i></div>
        <h4>Kewirausahaan</h4>
  ...
  <section class="praktik-section section-pad" id="praktik-aphp">
    <div class="praktik-head" data-reveal>
      <div class="eyebrow gold">BUKAN HANYA DI KELAS</div>
    ...
    <div class="praktik-grid">
      <div class="praktik-card" data-reveal>
        <img src="{{ asset('images/aphp-lab.jpg') }}" alt="Praktik eksperimen dan pengolahan" loading="lazy">
        <span class="pc-badge"><i class="fas fa-flask"></i> Praktik</span>
        <div class="pc-body">
          <h4>Praktik Laboratorium</h4>
          <p>Eksperimen dan pengolahan bahan di laboratorium APHP yang lengkap dan modern.</p>
        </div>
      </div>
      <div class="praktik-card" data-reveal style="--d:1">
        <img src="{{ asset('images/aphp-pastry.jpg') }}" alt="Produksi produk nyata" loading="lazy">
        <span class="pc-badge"><i class="fas fa-industry"></i> Produksi</span>
        <div class="pc-body">
          <h4>Unit Produksi</h4>
          <p>Menghasilkan produk nyata seperti teh markisa, roti ubi, dan aneka stik untuk dipasarkan.</p>
        </div>
      </div>
      <div class="praktik-card" data-reveal style="--d:2">
        ...
        <span class="pc-badge"><i class="fas fa-clipboard-check"></i> Evaluasi</span>
        <div class="pc-body">
          <h4>Evaluasi Produk</h4>
          <p>Menguji, mengevaluasi, dan mengembangkan produk berdasarkan standar mutu dan pasar.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="fasilitas-section section-pad" id="fasilitas-aphp">
    ...
    <div class="fasilitas-grid">
      <div class="fasilitas-card" data-reveal><div class="fc-ic"><i class="fas fa-flask"></i></div><h4>Laboratorium APHP</h4><p>Lab pengolahan lengkap dengan peralatan modern untuk praktik dan eksperimen.</p></div>
      <div class="fasilitas-card" data-reveal style="--d:1"><div class="fc-ic green"><i class="fas fa-tools"></i></div><h4>Peralatan Praktik</h4><p>Alat pengolahan, pengemasan, dan pengujian mutu yang memadai dan terawat.</p></div>
      <div class="fasilitas-card" data-reveal style="--d:2"><div class="fc-ic gold"><i class="fas fa-industry"></i></div><h4>Ruang Produksi</h4><p>Ruang produksi yang higienis dan sesuai standar keamanan pangan.</p></div>
      <div class="fasilitas-card" data-reveal style="--d:3"><div class="fc-ic"><i class="fas fa-box-open"></i></div><h4>Area Pengemasan</h4><p>Area khusus untuk pengemasan produk dengan standar mutu dan desain menarik.</p></div>
      <div class="fasilitas-card" data-reveal style="--d:4"><div class="fc-ic green"><i class="fas fa-snowflake"></i></div><h4>Penyimpanan</h4><p>Fasilitas penyimpanan bahan baku dan produk jadi yang terjaga kualitasnya.</p></div>
      <div class="fasilitas-card" data-reveal style="--d:5"><div class="fc-ic gold"><i class="fas fa-laptop"></i></div><h4>Fasilitas Pendukung</h4><p>Ruang kelas, perpustakaan, dan akses digital untuk menunjang pembelajaran.</p></div>
    </div>
  </section>
  ...
  <section class="produk-section section-pad" id="produk-aphp">
    ...
    <div class="produk-head" data-reveal>
      <div>
        ...
        <h2 class="big-heading">DARI IDE <span>MENJADI PRODUK</span></h2>
      </div>
    ...
    <div class="produk-filters" data-reveal>
      ...
      <button class="pf-btn" data-f="makanan">MAKANAN</button>
      <button class="pf-btn" data-f="minuman">MINUMAN</button>
      <button class="pf-btn" data-f="olahan">PRODUK OLAHAN</button>
    </div>
      ...
      <div class="produk-viewport">
        <div class="produk-track" id="produkTrack">
          <article class="produk-card" data-cat="makanan">
            <div class="produk-photo"><img src="{{ asset('images/aphp-produk1.jpg') }}" alt="MultiMie produk inovasi siswa APHP" loading="lazy"><span class="produk-badge">Makanan</span></div>
          ...
          <article class="produk-card" data-cat="olahan">
            <div class="produk-photo"><img src="{{ asset('images/aphp-olahan.jpg') }}" alt="Teh markisa produk olahan APHP" loading="lazy"><span class="produk-badge">Produk Olahan</span></div>
            <div class="pc-body"><h3>Teh Markisa</h3><p>Minuman herbal segar dari buah markisa — andalan unit produksi APHP.</p><div class="pc-foot"><span>Unit Produksi</span><span><i class="fas fa-arrow-right"></i></span></div></div>
          </article>
          <article class="produk-card" data-cat="makanan">
            <div class="produk-photo"><img src="{{ asset('images/aphp-cake.jpg') }}" alt="Roti ubi jalar karya siswa APHP" loading="lazy"><span class="produk-badge">Makanan</span></div>
            <div class="pc-body"><h3>Roti Ubi Jalar</h3><p>Roti manis berbahan ubi jalar kuning — sehat, mengenyangkan, dan bernilai jual.</p><div class="pc-foot"><span>Unit Produksi</span><span><i class="fas fa-arrow-right"></i></span></div></div>
          </article>
          <article class="produk-card" data-cat="makanan">
            <div class="produk-photo"><img src="{{ asset('images/aphp-pastry.jpg') }}" alt="Aneka stik produk APHP" loading="lazy"><span class="produk-badge">Makanan</span></div>
            <div class="pc-body"><h3>Aneka Stik</h3><p>Stik gurih dari bahan lokal — camilan favorit yang siap bersaing di pasaran.</p><div class="pc-foot"><span>Unit Produksi</span><span><i class="fas fa-arrow-right"></i></span></div></div>
          </article>
        </div>
      </div>
  ...
  <section class="kegiatan-section section-pad" id="kegiatan-aphp">
    ...
    <div class="kegiatan-grid">
      <div class="kegiatan-card tall" data-reveal>
        <img src="{{ asset('images/aphp-bersama.jpg') }}" alt="Prestasi siswa APHP" loading="lazy">
        <span class="kg-badge"><i class="fas fa-trophy"></i> Prestasi</span>
        <div class="kg-body"><h4>Prestasi Siswa APHP</h4><span>Juara lomba & penghargaan tingkat kota hingga nasional</span></div>
      </div>
      <div class="kegiatan-card" data-reveal style="--d:1">
        <img src="{{ asset('images/aphp-lab2.jpg') }}" alt="Praktik produksi APHP" loading="lazy">
        <span class="kg-badge"><i class="fas fa-flask"></i> Praktik</span>
        <div class="kg-body"><h4>Praktik Produksi</h4><span>Kegiatan praktik rutin di laboratorium APHP</span></div>
      </div>
      <div class="kegiatan-card" data-reveal style="--d:2">
        <img src="{{ asset('images/aphp-kampus.jpg') }}" alt="Kunjungan industri APHP" loading="lazy">
        <span class="kg-badge"><i class="fas fa-building"></i> Industri</span>
        <div class="kg-body"><h4>Kunjungan Industri</h4><span>Belajar langsung dari dunia industri pengolahan pangan</span></div>
      </div>
      <div class="kegiatan-card" data-reveal>
        <img src="{{ asset('images/aphp-penghargaan.jpg') }}" alt="Pameran produk APHP" loading="lazy">
        <span class="kg-badge"><i class="fas fa-box-open"></i> Pameran</span>
        <div class="kg-body"><h4>Pameran Produk</h4><span>Memamerkan produk unggulan di berbagai ajang</span></div>
      </div>
      <div class="kegiatan-card" data-reveal style="--d:1">
        <img src="{{ asset('images/aphp-tim.jpg') }}" alt="PKL siswa APHP" loading="lazy">
        <span class="kg-badge"><i class="fas fa-briefcase"></i> PKL</span>
        <div class="kg-body"><h4>PKL & Magang</h4><span>Pengalaman kerja langsung di industri dan perusahaan</span></div>
      </div>
    </div>
  </section>
  ...
  <section class="prospek-section section-pad" id="prospek-aphp">
    <div class="prospek-head" data-reveal>
      <div class="eyebrow gold">Mau ke Mana ya?</div>
      <h2 class="big-heading">SETELAH LULUS, <span>MAU KEMANA?</span></h2>
    </div>
    <div class="prospek-grid">
      <div class="prospek-card" data-reveal>
        <div class="ps-photo"><span class="ps-num">01</span><img src="{{ asset('images/aphp-piala.jpg') }}" alt="Bekerja di industri pangan" loading="lazy"><i class="fas fa-briefcase blue"></i></div>
        <div class="ps-body"><h4>KERJA</h4><p>Industri pangan, Quality Control, Produksi, Packaging, Marketing — siap kerja dengan sertifikat kompetensi.</p><div class="ps-tags"><span>Industri Pangan</span><span>QC</span><span>Produksi</span><span>Marketing</span></div></div>
      </div>
      <div class="prospek-card" data-reveal style="--d:1">
        <div class="ps-photo"><span class="ps-num">02</span><img src="{{ asset('images/aphp-kampus.jpg') }}" alt="Melanjutkan kuliah di bidang pangan" loading="lazy"><i class="fas fa-graduation-cap"></i></div>
        <div class="ps-body"><h4>KULIAH</h4><p>Teknologi pangan, Agribisnis, Gizi, atau bidang terkait — bekal APHP jadi modal kuat di perguruan tinggi.</p><div class="ps-tags"><span>Teknologi Pangan</span><span>Agribisnis</span><span>Gizi</span></div></div>
      </div>
      <div class="prospek-card" data-reveal style="--d:2">
        <div class="ps-photo"><span class="ps-num">03</span><img src="{{ asset('images/aphp-penghargaan.jpg') }}" alt="Membangun usaha sendiri" loading="lazy"><i class="fas fa-rocket green"></i></div>
        <div class="ps-body"><h4>USAHA</h4><p>Produk pangan, Unit produksi, Bisnis mandiri — bangun usaha sendiri dengan merek dan produkmu.</p><div class="ps-tags"><span>Produk Pangan</span><span>Unit Produksi</span><span>Bisnis</span></div></div>
      </div>
    </div>
  </section>
  ...
  <section class="cari-section section-pad" id="cari-jurusan">
    ...
    <div class="cari-head" data-reveal>
      ...
      <h2 class="big-heading">APHP COCOK <span>BUAT KAMU?</span></h2>
    </div>
    <div class="cari-card" data-reveal>
      ...
      <div id="cariQuiz" class="cari-quiz">
        ...
        <div class="cari-step active" data-q="1">
          ...
          <div class="cari-options">
            <div class="cari-opt" data-v="0"><span class="cari-opt-ic"><i class="fas fa-seedling"></i></span><span class="cari-opt-lb">Mengolah bahan dari alam</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="1"><span class="cari-opt-ic"><i class="fas fa-flask"></i></span><span class="cari-opt-lb">Bereksperimen dan menguji</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="2"><span class="cari-opt-ic"><i class="fas fa-bread-slice"></i></span><span class="cari-opt-lb">Membuat produk makanan</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="3"><span class="cari-opt-ic"><i class="fas fa-box-open"></i></span><span class="cari-opt-lb">Membuat kemasan & menjual</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="4"><span class="cari-opt-ic"><i class="fas fa-lightbulb"></i></span><span class="cari-opt-lb">Mengembangkan ide usaha</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
          </div>
        </div>
        <div class="cari-step" data-q="2">
          <h3 class="cari-ask">Mata pelajaran mana yang paling menarik?</h3>
          <div class="cari-options">
            <div class="cari-opt" data-v="2"><span class="cari-opt-ic"><i class="fas fa-microscope"></i></span><span class="cari-opt-lb">IPA & Biologi</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="1"><span class="cari-opt-ic"><i class="fas fa-flask"></i></span><span class="cari-opt-lb">Kimia & Analisis</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="0"><span class="cari-opt-ic"><i class="fas fa-wheat-awn"></i></span><span class="cari-opt-lb">Pertanian & Pangan</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="3"><span class="cari-opt-ic"><i class="fas fa-chart-line"></i></span><span class="cari-opt-lb">Ekonomi & Bisnis</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
        ...
        <div class="cari-step" data-q="3">
          <h3 class="cari-ask">Kalau bekerja di dapur produksi, kamu paling suka peran apa?</h3>
          <div class="cari-options">
            <div class="cari-opt" data-v="2"><span class="cari-opt-ic"><i class="fas fa-user-chef"></i></span><span class="cari-opt-lb">Mengolah & memasak</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="1"><span class="cari-opt-ic"><i class="fas fa-flask"></i></span><span class="cari-opt-lb">Menguji mutu produk</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="3"><span class="cari-opt-ic"><i class="fas fa-box-open"></i></span><span class="cari-opt-lb">Mengemas & mendesain</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            ...
            <div class="cari-opt" data-v="0"><span class="cari-opt-ic"><i class="fas fa-seedling"></i></span><span class="cari-opt-lb">Menyiapkan bahan baku</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
          </div>
        </div>
        <div class="cari-step" data-q="4">
          <h3 class="cari-ask">Apa tujuanmu setelah lulus SMK?</h3>
          <div class="cari-options">
            <div class="cari-opt" data-v="2"><span class="cari-opt-ic"><i class="fas fa-industry"></i></span><span class="cari-opt-lb">Bekerja di industri pangan</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="4"><span class="cari-opt-ic"><i class="fas fa-rocket"></i></span><span class="cari-opt-lb">Membangun usaha sendiri</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="0"><span class="cari-opt-ic"><i class="fas fa-graduation-cap"></i></span><span class="cari-opt-lb">Kuliah di bidang pangan</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="1"><span class="cari-opt-ic"><i class="fas fa-microscope"></i></span><span class="cari-opt-lb">Jadi ahli quality control</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="3"><span class="cari-opt-ic"><i class="fas fa-chart-line"></i></span><span class="cari-opt-lb">Bekerja di bagian marketing</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
          </div>
        </div>
        <div class="cari-step" data-q="5">
          <h3 class="cari-ask">Saat bekerja dalam tim, kamu biasanya?</h3>
          <div class="cari-options">
            <div class="cari-opt" data-v="2"><span class="cari-opt-ic"><i class="fas fa-handshake"></i></span><span class="cari-opt-lb">Praktik langsung di lapangan</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="3"><span class="cari-opt-ic"><i class="fas fa-calendar-check"></i></span><span class="cari-opt-lb">Mengatur jadwal & produksi</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="1"><span class="cari-opt-ic"><i class="fas fa-clipboard-list"></i></span><span class="cari-opt-lb">Mencatat & mengecek hasil</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="0"><span class="cari-opt-ic"><i class="fas fa-leaf"></i></span><span class="cari-opt-lb">Mencari ide dari alam</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
            <div class="cari-opt" data-v="4"><span class="cari-opt-ic"><i class="fas fa-lightbulb"></i></span><span class="cari-opt-lb">Memberi ide kreatif baru</span><span class="cari-check"><i class="fas fa-check"></i></span></div>
          </div>
        </div>
        <div class="cari-nav">
      ...
      <div class="cari-result" id="cariResult">
        ...
        <p class="cari-score-desc" id="cariScoreDesc">Kamu punya minat yang kuat pada pengolahan, eksperimen, dan menghasilkan produk nyata — semua itu ada di APHP.</p>
        <div class="cari-score-reasons" id="cariReasons"></div>
        <div class="cari-score-actions">
          <a href="#tentang-aphp" class="cari-cta-primary">Kenali APHP Lebih Dalam <i class="fas fa-arrow-right"></i></a>
  ...
  <section class="vt-section" id="lab-tour" aria-label="Lab Tour APHP SMK Negeri 2 Mojokerto">
    <span class="vt-watermark" aria-hidden="true">LAB</span>
      ...
      <div class="vt-media" data-reveal="left">
        <div class="vt-frame">
          ...
          <div class="vt-caption">
            <div><strong>Jelajahi Laboratorium APHP</strong><span>Fasilitas praktik Agribisnis Pengolahan Hasil Pertanian</span></div>
            <span class="vt-cam"><i class="fa-solid fa-camera"></i> LAB</span>
          </div>
        </div>
        <div class="vt-chip"><i class="fa-solid fa-compass"></i><div><strong>Lab Tour APHP</strong><span>Explore APHP Laboratory</span></div></div>
      </div>
      <div class="vt-copy">
        <div class="vt-kicker" data-reveal>Laboratory Experience</div>
  ...
  <section class="aphp-cta">
    ...
    <div class="orn" aria-hidden="true">
      <span class="o-chevron"></span><span class="o-dots"></span>
      <span class="o-ring"></span><span class="o-gold"></span>
      <i class="fas fa-wheat-awn o-wheat"></i>
    </div>
    <div class="aphp-cta-inner" data-reveal>
      <h2>Siap Menjadi Bagian dari <span>APHP?</span></h2>
      <p>Kenali potensimu, temukan pengalaman belajar yang sesuai, dan mulai perjalananmu bersama APHP — dari farm menuju future.</p>
...
(function(){
  ...
  function showResult(){
    ...
    if(score>=85){label.textContent='Sangat Cocok';desc.textContent='Minatmu sangat selaras dengan dunia APHP — pengolahan, eksperimen, dan produk nyata adalah duniamu. Kamu akan berkembang pesat di sini!'}
    else if(score>=75){label.textContent='Cocok';desc.textContent='Kamu punya ketertarikan kuat pada pengolahan dan produk. Dengan semangat praktik di APHP, potensimu akan terus terasah.'}
    else{label.textContent='Cukup Cocok';desc.textContent='Ada banyak sisi APHP yang bisa kamu eksplorasi — dari produksi hingga kewirausahaan. Coba kenali lebih dalam lewat tur di bawah!'}
    document.getElementById('cariReasons').innerHTML=[
      {t:'Praktik nyata setiap minggu',i:'fa-flask'},{t:'Belajar membuat produk sendiri',i:'fa-box-open'},{t:'Bekal wirausaha & industri',i:'fa-rocket'}
